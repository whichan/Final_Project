...
################################################################
# This is a generated script based on design: lidar_system
#
...
# source lidar_system_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set lidar1_rx [ create_bd_port -dir I lidar1_rx ]
  set lidar2_rx [ create_bd_port -dir I lidar2_rx ]

  # Create instance: LiDAR_0, and set properties
  set LiDAR_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:LiDAR:1.0 LiDAR_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins LiDAR_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net i_trigger_0_1 [get_bd_ports i_trigger] [get_bd_pins LiDAR_0/i_trigger]
  connect_bd_net -net lidar1_rx_0_1 [get_bd_ports lidar1_rx] [get_bd_pins LiDAR_0/lidar1_rx]
  connect_bd_net -net lidar2_rx_0_1 [get_bd_ports lidar2_rx] [get_bd_pins LiDAR_0/lidar2_rx]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LiDAR_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins LiDAR_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LiDAR_0/S00_AXI/S00_AXI_reg] -force
